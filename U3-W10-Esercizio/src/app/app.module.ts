...
@NgModule({
  declarations: [AppComponent, HeaderComponent, MainComponent, FooterComponent, HeaderSearchBarComponent, HeaderNavbarBrandComponent, HeaderNavbarCollapseComponent, HeaderItemDropdownComponent],
